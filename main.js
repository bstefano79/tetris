...
const celsBlock = {
    ...
    'J' : {'-S': {'draw' : ['0#0','0#1','0#2','1#0'], 'largeRight' : 3, 'largeLeft' : 0, 'shiftStartRow' : 1, 'shiftEndtRow' : 0}, '|G' : {'draw' : ['1#1','1#2','0#1','-1#1'], 'largeRight' : 3, 'largeLeft' : -1, 'shiftStartRow' : 1, 'shiftEndtRow' : 1}, '-D': {'draw' : ['0#0','0#1','0#2','-1#2'], 'largeRight' : 3, 'largeLeft' : 0, 'shiftStartRow' : 1, 'shiftEndtRow' : 1}, '|S' : {'draw' : ['-1#1','0#1','1#1','-1#0'], 'largeRight' : 2, 'largeLeft' : 0, 'shiftStartRow' : 1, 'shiftEndtRow' : 1}, 'start' : "-S", 'color' : '#00BFFF'},
